...
public class UnitTestKit {
  ...
  public static <K, V> void writeRecordsToTopic(TopologyTestDriver testDriver,
                                                String topic,
                                                List<KeyValue<K, V>> records,
  ...
  public static <K, V> Map<K, V> readTopicAsMap(TopologyTestDriver testDriver,
                                                String topic,
